...
final class Aspen_FBIM_Monitor {
	...
	private function discover() {
		...
		if ( null === $rows ) {
			return new WP_Error( 'aspen_fbim_query', __( 'FluentBooking Outlook connections could not be read.', 'aspen-fluentbooking-integration-monitor' ) );
		}
		...
		$snapshots = apply_filters( 'aspen_fbim_calendar_snapshots', $snapshots );
